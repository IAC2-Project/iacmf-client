...
export interface ComplianceRuleParameterEntityResponse { 
    name: string;
    type: ComplianceRuleParameterEntityResponse.TypeEnum;
}
export namespace ComplianceRuleParameterEntityResponse {
